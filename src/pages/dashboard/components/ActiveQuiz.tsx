...
export default function ActiveQuiz() {
  ...
  return (
    <div className="w-full min-h-[85vh] flex items-center justify-center p-4">
      <div className="w-full max-w-4xl p-6 bg-p3-surface border-2 border-p3-primary shadow-2xl -skew-x-2">
            ...
            <div className="flex flex-col gap-3">
              {currentQuestion.options.map((opt: AnswerOptionRead) => (
                <button
                  ...
                  className={`p-4 text-left font-jakarta text-sm transition-all -skew-x-4 border-2 cursor-pointer ${
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-wrap gap-2 pb-4 border-b border-p3-muted/20">
              {questions.map((q, idx) => (
                <button
                  ...
                  className={`w-10 h-10 font-kanit font-bold italic text-sm -skew-x-6 border cursor-pointer ${
                    currentIndex === idx
            ...
            <div className="flex justify-between items-center mt-6 pt-4 border-t border-p3-muted/20">
              <button
                ...
                className="font-jakarta font-extrabold text-xs -skew-x-6 px-4 py-2 bg-p3-primary text-p3-highlight disabled:opacity-40 cursor-pointer"
              >
                PREVIOUS
              </button>
              ...
              <button
                ...
                className="font-jakarta font-extrabold text-xs -skew-x-6 px-6 py-2 bg-red-600 hover:bg-red-700 text-white uppercase tracking-wider cursor-pointer"
              >
                FINISH & SUBMIT QUIZ
              </button>
